# Script to set up environment for BOS lab and kick of test (/home/ralongi/Documents/scripts/runtest_imp2.sh)

#!/bin/bash

sshpass -p redhat ssh root@impairment2.knqe.lab.eng.bos.redhat.com << "EOF"
