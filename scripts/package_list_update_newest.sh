...
cat $new_package_list_file >> ~/fdp_package_list.txt

scp ~/fdp_package_list.txt root@netqe-infra01.knqe.eng.rdu2.dc.redhat.com:/home/www/html/share/misc/fdp_package_list.txt
popd &>/dev/null
popd &>/dev/null
