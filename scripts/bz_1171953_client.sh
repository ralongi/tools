...
# run tests
for i in {1..5}; do bridge_vlan_nic; sleep 5m; done
for i in {1..5}; do vlan_bridge_nic; sleep 5m; done
for i in {1..5}; do vlan_nic; sleep 5m; done
for i in {1..5}; do bridge_nic; sleep 5m; done
