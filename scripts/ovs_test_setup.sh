...
ssh root@qe-dell-ovs3.knqe.lab.eng.bos.redhat.com << "EOF"
	...
	yum install kernel-kernel-networking-openvswitch-tests
...
ssh root@qe-dell-ovs1.knqe.lab.eng.bos.redhat.com << "EOF"
	# install beaker-client.repo
	wget -O /etc/yum.repos.d/beaker-client.repo http://download.lab.bos.redhat.com/beakerrepos/beaker-client-RedHatEnterpriseLinux.repo
