...
# usage:
# provision a beaker machine, ex. hp-dl380pg8-15.rhts.eng.pek2.redhat.com
# change root's passwd to redhat
# run command below in office machine
#
# ./vm_image.sh hp-dl380pg8-15.rhts.eng.pek2.redhat.com
#
...
TARGET_IMAGE=${TARGET_IMAGE:-rhel6.8}
...
rm -rf netperf-*
# install iperf
rpm -ivh http://netqe-infra01.knqe.lab.eng.bos.redhat.com/rpms/iperf-2.0.4-1.el7.rf.x86_64.rpm
