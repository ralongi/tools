...
# This script performs a level of reconfiguration on a newly reprovisioned system.
...
sshpass -p redhat ssh root@$target << "EOF"
	...
	# set up the repos to point to latest compose for currently loaded OS (RHEL 6 or 7)
