...
# --cmd-and-reboot 'dnf -y install wget; wget -O /etc/yum.repos.d/infra01-server.repo http://netqe-infra01.knqe.eng.rdu2.dc.redhat.com/infra01-server.repo; dnf -y install bcctools-4.18.0-553.7.1.el8_10 kernel-4.18.0-553.7.1.el8_10'
