...
# OVS packages
if [[ -z $RPM_OVS ]]; then
	export RPM_OVS=$OVS217_22D_RHEL8
else
...
if [[ -z $RPM_OVN_COMMON ]]; then
	if [[ $FDP_STREAM2 -gt 213 ]]; then
		export RPM_OVN_COMMON=$OVN_COMMON_2203_22D_RHEL8
	else
		export RPM_OVN_COMMON=$OVN_COMMON_217_22D_RHEL8
	fi
else
...
if [[ -z $RPM_OVN_CENTRAL ]]; then
	if [[ $FDP_STREAM2 -gt 213 ]]; then
		export RPM_OVN_CENTRAL=$OVN_CENTRAL_2203_22D_RHEL8
	else
		export RPM_OVN_CENTRAL=$OVN_CENTRAL_217_22D_RHEL8
	fi
else
...
if [[ -z $RPM_OVN_HOST ]]; then
	if [[ $FDP_STREAM2 -gt 213 ]]; then
		export RPM_OVN_HOST=$OVN_HOST_2203_22D_RHEL8
	else
		export RPM_OVN_HOST=$OVN_HOST_217_22D_RHEL8
	fi
else
...
if [[ -z $RPM_OVS_SELINUX_EXTRA_POLICY ]]; then
	export RPM_OVS_SELINUX_EXTRA_POLICY=$OVS_SELINUX_22D_RHEL8
else
...
# OVN packages
export RPM_OVN=$OVN217_22D_RHEL8 
